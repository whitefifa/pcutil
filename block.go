...
// KeyHeight returns a casted int64 height from the block header.
//
// This function should not be used for new code and will be
// removed in the future.
func (b *Block) KeyHeight() int64 {
	return int64(b.msgBlock.Header.KeyHeight)
}

// b

// PreHash returns the PrevBlock from the block header.
//
// This function should not be used for new code and will be
// removed in the future.
func (b *Block) PreHash() *chainhash.Hash {
	return &b.msgBlock.Header.PrevBlock
}

// PreKeyHash returns the PrevKeyBlock from the block header.
//
// This function should not be used for new code and will be
// removed in the future.
func (b *Block) PreKeyHash() *chainhash.Hash {
	return &b.msgBlock.Header.PrevKeyBlock
}
